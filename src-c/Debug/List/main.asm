...
_main:
; .FSTART _main
; 0000 0011 DDRC=255; //porthaye motassel be 7segmentha
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 0012 DDRD=255;
	OUT  0x11,R30
...
; 0000 001A 
; 0000 001B     for (i=12;i<=35;i++){   //joda kardane arghame adad
	LDI  R30,LOW(12)
	MOV  R5,R30
_0x8:
	LDI  R30,LOW(35)
...
; 0000 001E     n1=i/10;
	...
	MOV  R4,R30
; 0000 001F 
; 0000 0020     PORTC=Argham[n1];
	RCALL SUBOPT_0x0
	OUT  0x15,R30
; 0000 0021 
; 0000 0022     PORTD=Argham[n2];
	MOV  R30,R7
	RCALL SUBOPT_0x0
	OUT  0x12,R30
; 0000 0023 
; 0000 0024     delay_ms(550);
	LDI  R26,LOW(550)
	LDI  R27,HIGH(550)
	RCALL _delay_ms
; 0000 0025      }
...
SUBOPT_0x0:
	LDI  R31,0
	SUBI R30,LOW(-_Argham)
	SBCI R31,HIGH(-_Argham)
	LD   R30,Z
	RET
